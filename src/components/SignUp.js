...
export default function SignUp() {
    ...
    const [signUpInfo, setsignUpInfo] = useState({email:'', password:'',nacionality:''})
     
    const [newSignUp, setNewSignUp] = useState({email:'', password:'',nacionality:'en'})
    ...
    function submit(e) {
        ...
        setNewSignUp({email:'', password:'',nacionality:'en'})
    ...
    return (
        <>
            ...
            <div>
                <p>{changeLan(signUpInfo.nacionality)}</p>
