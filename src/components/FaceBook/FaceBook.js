    ...
    return (
      <div>
        <div className='all-countries'>
          <button 
            className={this.state.selected === 'All' ? 'country-btn selected' : 'country-btn'}
            onClick={(e) => this.toggleCountries(e)}
          >
            All
          </button>
          {uniqueCountries.map((e, i) => 
              <button 
                className={this.state.selected === e ? 'country-btn selected' : 'country-btn'}
                onClick={(e) => this.toggleCountries(e)} 
                key={i}
              >
                {e}
        ...
        {sortedProfiles.map((e, i) =>   
            <div 
              className={e.country === this.state.selected ? 'card selected' : 'card'} 
              key={i}
            >
