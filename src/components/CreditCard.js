        ...
        <div className="CreditCard card mb-3" style={{ backgroundColor: props.bgColor}}>
            <div className="row g-0">
                <div className="card-body">
                    <img src={img} width="50px" alt={props.type} align="right"/>
                    <p className="card-text"></p>
                    <h4 className="card-text pl-3"> <span>· · · · </span>&nbsp;<span> · · · · </span>&nbsp;<span> · · · · </span>&nbsp;{(props.number).substring(props.number.length - 4, props.number.length)}</h4>
