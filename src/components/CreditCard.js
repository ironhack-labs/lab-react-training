...
export default function CreditCard(props) {
    ...
    return (
        <>
        <div className="container alinearCuadro" style={{background:`${props.bgColor}`}}>
            <div>
                <img src={imagen} alt=""/>
            </div>
            <div className="cuerpo">{cuerpo}</div>
            <div className="row" style={{marginTop: '10px'}}>
                <div className="col-md-5 letraFecha">Expires {props.expirationMonth}/{props.expirationYear}</div>
