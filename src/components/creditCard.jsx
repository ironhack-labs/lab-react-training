...
function CreditCard ({
    ...
    const cardStyle = {
      ...
      return (
        ...
        <img src={cardImage} alt = {type} width="50" height = "30" className = "card-type-image" />
        </div>
        <div className="card-number"> •••• •••• •••• {lastDigits}</div>
        <div className="card-expiration"> Expires {expirationMonth}/{expirationYear}
        </div>
